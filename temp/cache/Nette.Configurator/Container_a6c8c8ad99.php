<?php
// source: C:\xampp\htdocs\bookhero\app/config/config.neon 
// source: C:\xampp\htdocs\bookhero\app/config/config.local.neon 

class Container_a6c8c8ad99 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\bookhero\app',
			'wwwDir' => 'C:\xampp\htdocs\bookhero\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp\htdocs\bookhero\app/../temp',
			'pdo' => [
				'connectionString' => 'mysql:host=127.0.0.1;dbname=app;charset=utf8',
				'username' => 'root',
				'password' => null,
			],
		];
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\bookhero\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_a6c8c8ad99 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\bookhero\app/../temp/cache/latte');
	...
	{
		$service = new \PDO('mysql:host=127.0.0.1;dbname=app;charset=utf8', 'root', null);
		return $service;
	}
